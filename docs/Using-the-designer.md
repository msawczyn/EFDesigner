...
<tr><td valign="top"> Entity Framework Package Version                                     </td><td valign="top"> <i>String</i>. The numeric version of Entity Framework to use (see <i>Entity Framework Version</i> immediately below), or "Latest" to use the most recent. Drives NuGet package installation and (for EFCore) code generation.</td></tr>
...
<tr><td valign="top"> Struct Output Directory                                              </td><td valign="top"> <i>String</i>. The project directory for generated dependent type (complex/owned type) files</td></tr>
...
<tr><td valign="top"> Install Nuget Packages On Save                                       </td><td valign="top"> <i>Boolean</i>. If true, will reset the references in the designer's project to load NuGet packages for the model's selected Entity Framework version.</td></tr>
