# ModelAttribute.InitialValue Property 
...
**C#**<br />
``` C#
public <a href="http://msdn2.microsoft.com/en-us/library/s1wwdcbf" target="_blank">string</a> InitialValue { get; set; }
```

**VB**<br />
``` VB
Public Property InitialValue As <a href="http://msdn2.microsoft.com/en-us/library/s1wwdcbf" target="_blank">String</a>
	Get
	Set
```
