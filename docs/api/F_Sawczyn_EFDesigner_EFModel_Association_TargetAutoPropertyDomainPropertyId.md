# Association.TargetAutoPropertyDomainPropertyId Field
...
**C#**<br />
``` C#
public static readonly <a href="http://msdn2.microsoft.com/en-us/library/cey1zx63" target="_blank">Guid</a> TargetAutoPropertyDomainPropertyId
```

**VB**<br />
``` VB
Public Shared ReadOnly TargetAutoPropertyDomainPropertyId As <a href="http://msdn2.microsoft.com/en-us/library/cey1zx63" target="_blank">Guid</a>
```
