# ModelRoot.CanLoadNugetPackages Property 
...
**C#**<br />
``` C#
public static <a href="http://msdn2.microsoft.com/en-us/library/a28wyd50" target="_blank">bool</a> CanLoadNugetPackages { get; set; }
```

**VB**<br />
``` VB
Public Shared Property CanLoadNugetPackages As <a href="http://msdn2.microsoft.com/en-us/library/a28wyd50" target="_blank">Boolean</a>
	Get
	Set
```

<a href="https://github.com/msawczyn/EFDesigner/tree/master/src/Dsl/CustomCode/Partials/ModelRoot.cs#L275" title="View the source code">View Source</a><br />
