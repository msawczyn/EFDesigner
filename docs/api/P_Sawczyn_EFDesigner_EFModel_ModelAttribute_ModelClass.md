# ModelAttribute.ModelClass Property 
...
**C#**<br />
``` C#
public virtual <a href="T_Sawczyn_EFDesigner_EFModel_ModelClass">ModelClass</a> ModelClass { get; set; }
```

**VB**<br />
``` VB
Public Overridable Property ModelClass As <a href="T_Sawczyn_EFDesigner_EFModel_ModelClass">ModelClass</a>
	Get
	Set
```
