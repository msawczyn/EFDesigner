# ModelBidirectionalAssociation Constructor 
 

Initializes a new instance of the <a href="T_ParsingModels_ModelBidirectionalAssociation">ModelBidirectionalAssociation</a> class
...
**C#**<br />
``` C#
public ModelBidirectionalAssociation()
```
