...
namespace Testing
{
   ...
   public partial class AllFeatureModel : DbContext
   {
      ...
      protected override void OnModelCreating(ModelBuilder modelBuilder)
      {
         ...
         modelBuilder.Entity<global::Testing.UParentOptional>().HasOne<global::Testing.UChild>(p => p.UChildOptional).WithOne().HasForeignKey<global::Testing.UChild>().OnDelete(DeleteBehavior.NoAction);
         modelBuilder.Entity<global::Testing.UParentOptional>().HasMany<global::Testing.UChild>(p => p.UChildCollection).WithOne().OnDelete(DeleteBehavior.NoAction);
