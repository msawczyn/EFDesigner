...
namespace Testing
{
   ...
   public partial class AllFeatureModel : DbContext
   {
      ...
      protected override void OnModelCreating(ModelBuilder modelBuilder)
      {
         ...
         modelBuilder.Entity<global::Testing.BChild>().HasOne(x => x.BParentOptional_2).WithOne(x => x.BChildOptional).HasForeignKey<global::Testing.BParentOptional>("KeyFoo");
         ...
         modelBuilder.Entity<global::Testing.BParentOptional>().HasIndex(t => t.KeyFoo);
