...
namespace Sandbox_EFCore
{
   ...
   public partial class EFModel : Microsoft.EntityFrameworkCore.DbContext
   {
      ...
      protected override void OnModelCreating(ModelBuilder modelBuilder)
      {
         ...
         modelBuilder.Entity<global::Sandbox_EFCore.PressReleaseDetail>().HasOne(x => x.PressRelease).WithMany(x => x.PressReleaseDetailHistory).HasForeignKey("PressRelease_Id");
