    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.UParentOptionals", t => t.UParentOptional_UChildCollection_Id)
            ...
            CreateTable(
                "dbo.AbstractBaseClasses",
                c => new
                    {
                        Id = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.BaseClassWithRequiredProperties", t => t.Id)
                .Index(t => t.Id);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AbstractBaseClasses", t => t.Id)
                .Index(t => t.Id);
            
            CreateTable(
                "dbo.ConcreteDerivedClassWithRequiredProperties",
                c => new
                    {
                        Id = c.Int(nullable: false),
                        Property1 = c.String(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AbstractBaseClasses", t => t.Id)
                .Index(t => t.Id);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.HiddenEntities", t => t.Id)
        ...
        {
            DropForeignKey("dbo.UParentOptionals", "Id", "dbo.UChilds");
            DropForeignKey("dbo.UParentOptionals", "UChildOptional_Id", "dbo.UChilds");
            DropForeignKey("dbo.UParentOptionals", "Id", "dbo.HiddenEntities");
            DropForeignKey("dbo.DerivedClasses", "Id", "dbo.BaseClasses");
            DropForeignKey("dbo.ConcreteDerivedClassWithRequiredProperties", "Id", "dbo.AbstractBaseClasses");
            DropForeignKey("dbo.ConcreteDerivedClasses", "Id", "dbo.AbstractBaseClasses");
            DropForeignKey("dbo.BaseClasses", "Id", "dbo.BaseClassWithRequiredProperties");
            DropForeignKey("dbo.AbstractBaseClasses", "Id", "dbo.BaseClassWithRequiredProperties");
            ...
            DropForeignKey("dbo.UChilds", "UParentOptional_UChildCollection_Id", "dbo.UParentOptionals");
            ...
            DropIndex("dbo.UParentOptionals", new[] { "UChildOptional_Id" });
            DropIndex("dbo.UParentOptionals", new[] { "Id" });
            DropIndex("dbo.DerivedClasses", new[] { "Id" });
            DropIndex("dbo.ConcreteDerivedClassWithRequiredProperties", new[] { "Id" });
            DropIndex("dbo.ConcreteDerivedClasses", new[] { "Id" });
            DropIndex("dbo.BaseClasses", new[] { "Id" });
            DropIndex("dbo.AbstractBaseClasses", new[] { "Id" });
            ...
            DropTable("dbo.UParentOptionals");
            DropTable("dbo.DerivedClasses");
            DropTable("dbo.ConcreteDerivedClassWithRequiredProperties");
            DropTable("dbo.ConcreteDerivedClasses");
            DropTable("dbo.BaseClasses");
            DropTable("dbo.AbstractBaseClasses");
