...
namespace Testing
{
   ...
   public partial class AllFeatureModel : DbContext
   {
      ...
      protected override void OnModelCreating(ModelBuilder modelBuilder)
      {
         ...
         modelBuilder.Entity<global::Testing.BParentCollection>().Navigation(e => e.BChildRequired).HasField("_bChildRequired").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         modelBuilder.Entity<global::Testing.BChild>().Navigation(e => e.BParentCollection).HasField("_bParentCollection").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         ...
         modelBuilder.Entity<global::Testing.BParentCollection>().Navigation(e => e.BChildCollection).HasField("_bChildCollection").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         modelBuilder.Entity<global::Testing.BChild>().Navigation(e => e.BParentCollection_1).HasField("_bParentCollection_1").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         ...
         modelBuilder.Entity<global::Testing.BParentCollection>().Navigation(e => e.BChildOptional).HasField("_bChildOptional").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         modelBuilder.Entity<global::Testing.BChild>().Navigation(e => e.BParentCollection_2).HasField("_bParentCollection_2").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         ...
         modelBuilder.Entity<global::Testing.BParentOptional>().Navigation(e => e.BChildRequired).HasField("_bChildRequired").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         modelBuilder.Entity<global::Testing.BChild>().Navigation(e => e.BParentOptional).HasField("_bParentOptional").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         ...
         modelBuilder.Entity<global::Testing.BParentOptional>().Navigation(e => e.BChildCollection).HasField("_bChildCollection").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         modelBuilder.Entity<global::Testing.BChild>().Navigation(e => e.BParentOptional_1).HasField("_bParentOptional_1").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         ...
         modelBuilder.Entity<global::Testing.BParentOptional>().Navigation(e => e.BChildOptional).HasField("_bChildOptional").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         modelBuilder.Entity<global::Testing.BChild>().Navigation(e => e.BParentOptional_2).HasField("_bParentOptional_2").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         ...
         modelBuilder.Entity<global::Testing.BParentRequired>().Navigation(e => e.BChildOptional).HasField("_bChildOptional").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         modelBuilder.Entity<global::Testing.BChild>().Navigation(e => e.BParentRequired).HasField("_bParentRequired").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         ...
         modelBuilder.Entity<global::Testing.BParentRequired>().Navigation(e => e.BChildRequired).HasField("_bChildRequired").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         modelBuilder.Entity<global::Testing.BChild>().Navigation(e => e.BParentRequired_1).HasField("_bParentRequired_1").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         ...
         modelBuilder.Entity<global::Testing.BParentRequired>().Navigation(e => e.BChildCollection).HasField("_bChildCollection").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         modelBuilder.Entity<global::Testing.BChild>().Navigation(e => e.BParentRequired_2).HasField("_bParentRequired_2").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         ...
         modelBuilder.Entity<global::Testing.Child>().Navigation(e => e.Children).HasField("_children").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         modelBuilder.Entity<global::Testing.Child>().Navigation(e => e.Parent).HasField("_parent").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
         ...
         modelBuilder.Entity<global::Testing.UParentCollection>().Navigation(e => e.UChildCollection).HasField("_uChildCollection").UsePropertyAccessMode(PropertyAccessMode.FieldDuringConstruction);
