...
namespace Testing
{
   ...
   public partial class AllFeatureModel : DbContext
   {
      ...
      protected override void OnModelCreating(ModelBuilder modelBuilder)
      {
         ...
         modelBuilder.Entity<global::Testing.BChild>().Property(t => t.Property1).HasField("_property1").UsePropertyAccessMode(PropertyAccessMode.Property);
         ...
         modelBuilder.Entity<global::Testing.BChild>().HasMany(x => x.BParentCollection).WithOne(x => x.BChildRequired);
         modelBuilder.Entity<global::Testing.BChild>().Navigation(x => x.BParentCollection).HasField("FieldName").UsePropertyAccessMode(PropertyAccessMode.Property);
         ...
         modelBuilder.Entity<global::Testing.UParentOptional>().Property(t => t.PropertyInChild).HasField("_propertyInChild").UsePropertyAccessMode(PropertyAccessMode.Property).HasDefaultValue("hello");
         ...
         modelBuilder.Entity<global::Testing.UParentRequired>().Property(t => t.Property1ab).HasField("_property1ab").UsePropertyAccessMode(PropertyAccessMode.Property);
