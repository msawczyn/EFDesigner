...
namespace ClassLibrary_Framework
{
   /// <inheritdoc/>
   public partial class EFModel : Microsoft.EntityFrameworkCore.DbContext
   {
      #region DbSets
      public virtual Microsoft.EntityFrameworkCore.DbSet<ClassLibrary_Framework.Entity1> Entity1 { get; set; }
      #endregion DbSets
      ...
      protected override void OnModelCreating(ModelBuilder modelBuilder)
      {
         ...
         modelBuilder.Entity<ClassLibrary_Framework.Entity1>()
                     .ToTable("Entity1")
                     .HasKey(t => t.Id);
         modelBuilder.Entity<ClassLibrary_Framework.Entity1>()
                     .Property(t => t.Id)
