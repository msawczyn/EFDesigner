...
namespace Testing
{
   public partial class AllFeatureModel : Microsoft.EntityFrameworkCore.DbContext
   {
      ...
      protected override void OnModelCreating(Microsoft.EntityFrameworkCore.ModelBuilder modelBuilder)
      {
         ...
         modelBuilder.Entity<AllPropertyTypesOptional>().Property(t => t.Id).IsRequired().HasAnnotation("Index", new IndexAnnotation(new IndexAttribute())).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
