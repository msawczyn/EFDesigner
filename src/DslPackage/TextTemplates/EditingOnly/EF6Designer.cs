...
namespace Sawczyn.EFDesigner.EFModel.DslPackage.TextTemplates.EditingOnly
{
   ...
   partial class EditOnly
   {
      ...
      {
         public EF6ModelGenerator(Manager manager, ModelRoot modelRoot) : base(manager, modelRoot) {}
         ...
         protected void WriteDatabaseInitializer()
         {
         ...
         protected void WriteDbContext()
         {
            ...
            WriteConstructors();
            WriteModelCreate(classesWithTables);
         ...
         protected void WriteModelCreate(ModelClass[] classesWithTables)
         {
         ...
         protected void WriteMigrationConfiguration()
         {
