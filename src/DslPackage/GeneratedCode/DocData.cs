...
namespace Sawczyn.EFDesigner.EFModel
{
	...
	internal abstract partial class EFModelDocDataBase : DslShell::ModelingDocData
	{
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			modelRoot = global::Sawczyn.EFDesigner.EFModel.EFModelSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, this.ValidationController, this.SerializerLocator);
