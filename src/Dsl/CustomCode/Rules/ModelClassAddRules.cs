   ...
   internal class ModelClassAddRules : AddRule
   {
      public override void ElementAdded(ElementAddedEventArgs e)
      {
         ...
         if (!element.AllIdentityAttributes.Any() && !element.IsDependentType)
         {
            ...
            {
               ModelAttribute newAttribute = new ModelAttribute(element.Partition) {Name = "Id", Type = modelRoot.DefaultIdentityType, IsIdentity = true, IdentityType = IdentityType.AutoGenerated};
         ...
         {
            ModelAttribute concurrencyToken = new ModelAttribute(element.Partition) {Name = "Timestamp", Type = "Binary", IsConcurrencyToken = true};
