...
namespace Sawczyn.EFDesigner.EFModel
{
	...
	public abstract class EFModelToolboxHelperBase
	{
		...
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "EFModel.2.0";
		/// <summary>
		/// Toolbox item filter string used to identify ModelClass element tool.
		/// </summary>
		public const string ModelClassFilterString = "ModelClass.2.0";
		/// <summary>
		/// Toolbox item filter string used to identify UnidirectionalAssociation connector tool.
		/// </summary>
		public const string UnidirectionalAssociationFilterString = "UnidirectionalAssociation.2.0";
		/// <summary>
		/// Toolbox item filter string used to identify BidirectionalAssociation connector tool.
		/// </summary>
		public const string BidirectionalAssociationFilterString = "BidirectionalAssociation.2.0";
		/// <summary>
		/// Toolbox item filter string used to identify Generalization connector tool.
		/// </summary>
		public const string GeneralizationFilterString = "Generalization.2.0";
		/// <summary>
		/// Toolbox item filter string used to identify Comment element tool.
		/// </summary>
		public const string CommentFilterString = "Comment.2.0";
		/// <summary>
		/// Toolbox item filter string used to identify CommentLink connector tool.
		/// </summary>
		public const string CommentLinkFilterString = "CommentLink.2.0";
		/// <summary>
		/// Toolbox item filter string used to identify Enumeration element tool.
		/// </summary>
		public const string EnumerationFilterString = "Enumeration.2.0";
